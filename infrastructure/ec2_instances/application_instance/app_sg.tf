resource "aws_security_group" "security_group" {
  ...
  ingress {
    from_port   = var.application_ingress_from_port[4]
    to_port     = var.application_ingress_to_port[4]
    protocol    = var.application_protocol
    cidr_blocks = var.application_cidr_block
  }

  ingress {
    from_port   = var.application_ingress_from_port[5]
    to_port     = var.application_ingress_to_port[5]
    protocol    = var.application_protocol
    cidr_blocks = var.application_cidr_block
  }
